...
class SingleService (val view : HomeFragment){

//    fun tryPatchGroup(userIdx : Int) {
...
//            ) {
//                response.body()?.let {
//                    if(it.isSuccess) view.onPatchSingleStatusSuccess(response.body() as SingleResultResponse)
//                    else {
//                        when(it.code) {
